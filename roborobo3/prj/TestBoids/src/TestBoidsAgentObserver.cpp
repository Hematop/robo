...
TestBoidsAgentObserver::TestBoidsAgentObserver( RobotWorldModel *wm )
{
    _wm = (RobotWorldModel*)wm;
    
}

TestBoidsAgentObserver::~TestBoidsAgentObserver()
{
    // nothing to do.
}

void TestBoidsAgentObserver::reset()
{
    // nothing to do.
}

void TestBoidsAgentObserver::step()
{
