...
SwapWalkAgentObserver::SwapWalkAgentObserver( )
{
}

SwapWalkAgentObserver::SwapWalkAgentObserver( RobotWorldModel *__wm )
{
	_wm = __wm;
}
...
void SwapWalkAgentObserver::reset()
{
	// nothing to do.
}

void SwapWalkAgentObserver::step()
{
