...
CustomBoidsController::CustomBoidsController( RobotWorldModel *wm )
{
    _wm = wm;
...
CustomBoidsController::~CustomBoidsController()
{
}

void CustomBoidsController::reset()
{
}

void CustomBoidsController::step()
{
    _iteration++;
    ...
    double attractionRadius = gSensorRange*1; // 0.7 // if ( attractionRadius < repulsiveRadius ) then: assume attractionRadius=repulsiveRadius
...
/*
void CustomBoidsController::step() // THIS IS A TEMPLATE FOR PRACTICAL APPLICATION (moving like an idiot , gathering sensory information for nothing)
{
    _iteration++;
