...
double MoveSwapSharedData::gSourceSpeed = 1; // speed of sr-altering perturbation
...
double MoveSwapSharedData::gCenterX = 300, MoveSwapSharedData::gCenterY = 300; // position of energy-giving center
int MoveSwapSharedData::gDistToRim = 50; // distance of perturbation center to image rim
