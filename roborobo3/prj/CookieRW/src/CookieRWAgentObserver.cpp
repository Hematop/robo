...
CookieRWAgentObserver::CookieRWAgentObserver( )
{
}

CookieRWAgentObserver::CookieRWAgentObserver( RobotWorldModel *__wm )
{
	_wm = __wm;
}
...
void CookieRWAgentObserver::reset()
{
	// nothing to do.
}

void CookieRWAgentObserver::step()
{
