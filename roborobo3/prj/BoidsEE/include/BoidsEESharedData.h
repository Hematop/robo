...
#ifndef BOIDSEESHAREDDATA_H
#define BOIDSEESHAREDDATA_H

class BoidsEESharedData {
...
public:
    ...
    static bool gEnergyRequestOutput; // can the robot modulate its energy request (when being given some) ?
