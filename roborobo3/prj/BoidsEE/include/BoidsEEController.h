...
#ifndef BOIDSEECONTROLLER_H
#define BOIDSEECONTROLLER_H
...
class BoidsEEController : public Controller
{
protected:
    int _iteration;
    int _birthdate; // evaluation when this controller was initialized.
        
    // double _repulsiveRadius;
    // double _attractiveRadius;
...
public:
    ...
    BoidsEEController(RobotWorldModel *wm);
    ~BoidsEEController();
